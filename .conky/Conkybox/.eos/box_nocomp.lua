...
colour - table of colours, default = plain white {{1,0x000000,0.5}}
...
colour={{0.5,0x000000,1},{1,0x000000,0}},
...
if t.colour==nil then t.colour={{1,0x000000,0.5}} end
