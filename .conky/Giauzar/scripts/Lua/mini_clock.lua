...
seconds_ring_width       = 2,               -- seconds ring width
seconds_ring_base_color  = {0xFFFFFF, 0.1}, -- base color
seconds_ring_fill_color  = {0xFFFFFF, 0.5}, -- fill color
seconds_ring_fill_colorS = {0xFFFFFF, 0.5},

-- Main settings
xc = 155, -- centre of the clock
yc = 155,
R  = 140, -- default radius of the clock
RH = 100,  -- outher radius for hours fill ring
RM = 120,  -- outer radius for minutes fill ring
rh = 7,  -- hour ring fill raius
rm = 7,  -- minutes ring fill radius
rs = 7,  -- seconds ring fill radius
...
fill_color       = {0x3B3D50, 1},   -- fill color for hour+minutes ring
fill_colorS      = {0xA30FE0, 1},   -- fill color for seconds ring
